...
//personal details
//$id=$_GET['id'];
$query = "UPDATE devices SET name='$devicename', make='$make', model='$model', sno='$sno',type='$type', location='$location', bought='$firstuse',insp_freq='$ifreq', service_freq='$l_insp', last_insp='$ssfreq', last_service='$l_ser',status='$cstatus',
 remarks='$remarks',dept='$dept',date='$date',added_by='$user'WHERE id='$id'";
...
<div class="alert alert-success alert-dismissible">
                ...
                <h4><i class="icon fa fa-check"></i> Device/Machinery Inspection Successful!</h4>
</div>
                   ...
                   while($row = mysqli_fetch_assoc($result))
                     {
                  	...
                  	echo"<option name='devicename' value=".$row['id'].">".$row['name']."</option>";
