...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       <small>Add Device / equipment  / machinery  Category e,g Cold store, compressor, water pump, CPU, Rosenta Phone, Washing Machine etc..</small>
      </h1>
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label">Device Category</label>

                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="devicetype" id="devicetype" placeholder="Machinery/Device Category" required="required">
                  </div>
                </div>
...
//personal details
$query = "INSERT into devicetype( type, added_by)
VALUES('$devicetype','$user')";
...
<div class="alert alert-success alert-dismissible">
                ...
                <h4><i class="icon fa fa-check"></i> Category added</h4>
</div>
...
<div class="alert alert-danger alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-ban"></i> Category not saved!, try again, check your network or seek help </h4>
                              </div>
