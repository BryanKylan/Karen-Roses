...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       <small>Add Maintenance/Service/Inspection Schedule e.g daily, hourly, weekly etc..</small>
      </h1>
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="schedule" id="schedule" placeholder="Inspection Schedule" required="required">
                  </div>
                </div>
...
//personal details
$query = "INSERT into sfreq( freq, added_by)
VALUES('$freq','$user')";
...
<div class="alert alert-success alert-dismissible">
                ...
                <h4><i class="icon fa fa-check"></i> Schedule added</h4>
</div>
...
<div class="alert alert-danger alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-ban"></i> Schedule not saved!, try again, check your network or seek help </h4>
                              </div>
